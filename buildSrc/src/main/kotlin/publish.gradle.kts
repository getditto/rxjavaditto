        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/getditto/rxjavaditto/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/getditto/rxjavaditto.git")
                        developerConnection.set("scm:git:ssh://github.com/getditto/rxjavaditto.git")
                        url.set("https://github.com/getditto/rxjavaditto/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/getditto/rxjavaditto/issues")
                    }
                }
            }
        }
